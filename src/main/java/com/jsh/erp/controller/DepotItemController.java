...
public class DepotItemController {
    ...
    public BaseResponseInfo buyOrSalePrice(HttpServletRequest request, HttpServletResponse response)throws Exception {
        ...
        String message = "成功";
        try {
            List<String> list = Tools.getLastDays(7);
            List<String> list1 = Tools.getLastLDays(7);
            map.put("monthList", list);
            List<BigDecimal> cwmt= new ArrayList<BigDecimal>();
            List<BigDecimal> cwwjtz = new ArrayList<BigDecimal>();
            List<BigDecimal> gzxxb = new ArrayList<BigDecimal>();
            List<BigDecimal> hbxzwy = new ArrayList<BigDecimal>();
            List<BigDecimal> sdqz = new ArrayList<BigDecimal>();
            List<BigDecimal> ydrbxz1 = new ArrayList<BigDecimal>();
            List<BigDecimal> ydrbx= new ArrayList<BigDecimal>();
            List<BigDecimal> cwnd= new ArrayList<BigDecimal>();
            for(String days: list) {
                BigDecimal outNum1 = depotItemService.outDetailNum("出库", "零售", days, "宠物毛毯");
                BigDecimal outNum2 = depotItemService.outDetailNum("出库", "零售", days, "宠物玩具套餐");
                BigDecimal outNum3 = depotItemService.outDetailNum("出库", "零售", days, "格子熊胸背");
                BigDecimal outNum4 = depotItemService.outDetailNum("出库", "零售", days, "滑板小子卫衣");
                BigDecimal outNum5 = depotItemService.outDetailNum("出库", "零售", days, "圣诞裙子");
                BigDecimal outNum6 = depotItemService.outDetailNum("出库", "零售", days, "云朵绒背心 Z1");
                BigDecimal outNum7 = depotItemService.outDetailNum("出库", "零售", days, "云朵绒背心");
                BigDecimal outNum8 = depotItemService.outDetailNum("出库", "零售", days, "宠物尿垫");
                cwmt.add(outNum1);
                cwwjtz.add(outNum2);
                gzxxb.add(outNum3);
                hbxzwy.add(outNum4);
            ...
            map.put("ydrbx", ydrbx);
            map.put("cwnd", cwnd);
            List<BigDecimal> saleNumList = new ArrayList<BigDecimal>();
            List<BigDecimal> saleNumListL = new ArrayList<BigDecimal>();
            for(String days: list) {
                BigDecimal outNum = depotItemService.inOrOutNum("出库", "零售", days);
                saleNumList.add(outNum);
            }
            map.put("saleNumList", saleNumList);
            for(String days: list1) {
                BigDecimal outNum = depotItemService.inOrOutNum("出库", "零售", days);
                saleNumListL.add(outNum);
            }
            map.put("saleNumListL", saleNumListL);
            res.code = 200;
            res.data = map;
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @throws Exception
     */
    @GetMapping(value = "/todaySaleNum")
    public BaseResponseInfo todaySaleNum() {
        BaseResponseInfo res = new BaseResponseInfo();
        Map<String, Object> map = new HashMap<String, Object>();
        String message = "成功";
        try {
