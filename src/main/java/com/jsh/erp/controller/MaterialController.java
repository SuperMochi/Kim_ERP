...
public class MaterialController {
     ...
     * @return
     */
    @PostMapping(value = "/importExcelForSale")
    public void importExcelForSale(MultipartFile materialFile,
                            HttpServletRequest request, HttpServletResponse response) throws Exception{
        BaseResponseInfo info = new BaseResponseInfo();
        Map<String, Object> data = new HashMap<String, Object>();
        String message = "成功";
        try {
            ...
            info = materialService.importExcelForsale(src);
        } catch (Exception e) {
            e.printStackTrace();
            message = "导入失败";
            info.code = 500;
        ...
        response.sendRedirect("../pages/bill/retail_out_list.html");
    }
