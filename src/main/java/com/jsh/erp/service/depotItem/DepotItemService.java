...
public class DepotItemService {
     ...
     * @throws Exception
     */
    public BigDecimal outDetailNum(String type, String subType, String dayTime,String name) throws Exception{
        BigDecimal result= BigDecimal.ZERO;
        try{
            result = depotItemMapperEx.outDetailNum(type, subType, dayTime,name);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return result;
    }
    public List<DepotItem> outDetailByName(String type, String subType, String dayTime, String name) throws Exception{
        List<DepotItem> list =null;
        try{
            list = depotItemMapperEx.outDetailByName(type, subType, dayTime,name);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return list;
    }
    public BigDecimal inOrOutNum(String type, String subType, String dayTime) throws Exception{
        BigDecimal result= BigDecimal.ZERO;
        try{
            result = depotItemMapperEx.inOrOutNum(type, subType, dayTime);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return result;
